...
| API 缺少版本化 | api/external 无版本号 | 采用 /api/v1/ 结构化版本管理 | 🔴 未处理 |
...
7. [ ] **改进 CSP 策略** - 使用 nonce-based CSP
8. [ ] **拆分臃肿 Controller** - AccountsController 提取服务对象
9. [ ] **合并 Stimulus 控制器** - 简化 57 个控制器文件
10. [ ] **API 版本化** - 采用 /api/v1/ 结构
11. [ ] **Category N+1 优化** - descendants/ancestors 使用 CTE 替代递归

### 低优先级 🔴 待处理

12. [ ] **简化预算表结构** - 统一 budgets/single_budgets
13. [ ] **补充前端测试** - 添加 Jest/Vitest
...
**审查报告已更新。已完成 5 项高优先级修复，剩余 11 项待处理。**
